...
getSum grid [] [] = 0
getSum grid (startSlotsH:startSlotsT) (allBehavioursH:allBehavioursT) = getCoins grid startSlotsH allBehavioursH + getSum grid startSlotsT allBehavioursT
...
main = do
    ...
    let sum = getSum grid (getStartSlots grid) allBehaviours
